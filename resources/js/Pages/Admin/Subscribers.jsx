...
const count = Math.ceil(subscribers.length / PER_PAGE);
const _DATA = usePagination(subscribers, PER_PAGE);
...
const handleChange = (e, p) => {
  ...
  _DATA.jump(p);
    ...
    const found = subscribers.filter(obj => Object.values(obj).some(val => typeof val == "string" && val.includes(values.search)))
                                ...
                                <tbody>
                                    {_DATA.currentData().map((data, index)=>{
                                        return(<tr key={index}>
                                            ...
                                            {/* <td><Link href={`/edit-users/${data.id}`}>edit</Link></td> */}
                                        </tr>)
                                    })}
                                </tbody>
                            </Table>
