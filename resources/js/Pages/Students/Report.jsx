...
export default function Users(props){
     ...
     */
    const {report, programs}=usePage().props;
        ...
        <>
         <AuthenticatedLayout
            ...
            header={<>
                ...
                <h3 className="fs-4 text-color-blue">My Report</h3>
            </>}
                        ...
                        <div  className="p-6 border-b border-gray-200">
                            <Table striped bordered hover>
                                ...
                                <tbody>
                                  ...
                                  }): <tr><td  className="text-center fs-6 p-2 pt-4 fw-bold">No result yet.</td></tr>}
                                </tbody>
                            </Table>
                          </div>
                        </div>
